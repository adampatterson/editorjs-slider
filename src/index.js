 ...
 */
export default class MakerSlider {
    /**
     ...
     * @param {MakerSliderData} tool.data - previously saved data
     ...
     *
     * @param {MakerSliderData} savedData — data received after saving
     ...
     * @private
     *
     * @param {MakerSliderDataFile} file - uploaded file data
     */
    appendImage(file) {
        if (file && file.url) {
     ...
     * @private
     *
     * @param {MakerSliderData} data - data in Image Tool format
     */
    set data(data) {
        this._data.files = [];
        if (data.files) {
