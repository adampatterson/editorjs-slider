...
class ce {
   ...
   * Renders tool UI
   *
   * @param {MakerSliderData} toolData - saved tool data
   * @returns {Element}
   */
  render(e) {
   ...
   * Shows an image
   *
   * @param {MakerSliderDataFile} file - image file object
   * @returns {void}
   */
  appendImage(e) {
    let t = e.url;
...
class ut {
   ...
   *
   * @param {MakerSliderData} toolData - generate Elements of tunes
   * @returns {Element}
   */
  render(e) {
